...
dev-browser --connect observe --page TARGET --within main   # 2. compact tree + refs
...
JSON output is compact and single-line by default. Use global `--pretty` for indented human-readable JSON; it does not change the response fields.
